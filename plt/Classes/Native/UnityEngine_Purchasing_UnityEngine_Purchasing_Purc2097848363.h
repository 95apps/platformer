...
struct  PurchaseFailureReason_t2097848363 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(PurchaseFailureReason_t2097848363, ___value___1)); }
