...
public class Raycast : MonoBehaviour {
	...
	void FixedUpdate () {
		...
		Debug.DrawLine (transform.position + corner2, transform.position + corner2 + dwn, Color.red);
		Debug.DrawLine (transform.position + corner3, transform.position + corner3 + dwn, Color.red);
		Debug.DrawLine (transform.position + corner4, transform.position + corner4 + dwn, Color.red);
