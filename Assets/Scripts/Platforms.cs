...
public class Platforms : MonoBehaviour
{
    ...
    public void SpawnPlatform()
    {
        ...
        if(direction == 0)
        {
            ...
            newPlat.transform.position = new Vector3(lastPlatPosition.x + randomCord, lastPlatPosition.y + 1f, lastPlatPosition.z + 3);
            newPlat.transform.eulerAngles = new Vector3(0, 0, 0);
        } if (direction == 1)
        {
            newPlat.transform.position = new Vector3(lastPlatPosition.x + 3, lastPlatPosition.y + 1f, lastPlatPosition.z + randomCord);
